...
var URLHTMLFILE_DEFAULT = "http://quiet-mesa-9689.herokuapp.com";
...
var checkFileFromURL = function(fileFromURL, checksfile){
  var checks = loadChecks(checksfile).sort();
  var out = {};
  for (var ii in checks) {
    var present = $(checks[ii]).length > 0;
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url>', 'url to check', clone(assertURLExists),  URLHTMLFILE_DEFAULT)
        .parse(process.argv);
